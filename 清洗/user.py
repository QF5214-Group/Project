...
big_talk = big_talk[['user' ,'activity' ,'merit']]
big_talk.rename(columns={'user': 'talk_user', 'activity': 'talk_user_activity', 'merit': 'talk_user_merit'}, inplace=True)

big_talk = big_talk.drop_duplicates()
big_talk = big_talk.drop_duplicates(subset=['talk_user'])

#big_talk_path = r'C:\Users\User\Desktop\out_and_in\raw data\talk_user.csv'
