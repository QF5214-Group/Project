...
big_talk = big_talk[['subject' ,'date' ,'replies' ,'views' ,'subject_sentiment' ,'subject_subjectivity']]
big_talk.rename(columns={'subject': 'talk_subject', 'date': 'date', }, inplace=True)
big_talk.rename(columns={'replies': 'talk_subject_replies', 'views': 'talk_subject_views', }, inplace=True)
big_talk.rename(columns={'subject_sentiment': 'talk_subject_emotion', 'subject_subjectivity': 'talk_subject_subjectivity', }, inplace=True)

big_talk = big_talk.drop_duplicates()
big_talk = big_talk.drop_duplicates(subset=['talk_subject'])



big_talk = big_talk.sort_values(by='date', ascending=False)

#big_talk_path = r'C:\Users\User\Desktop\out_and_in\raw data\talk_subject.csv'
